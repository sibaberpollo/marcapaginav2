  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-bg-primary border-t border-surface-2 z-50">
      <div className="flex justify-around py-2">
        ...
        {/* A pie de página */}
        <Link href="/categoria/a-pie-de-pagina" className="flex flex-col items-center gap-1 p-2 text-brand-gray">
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        {/* Previews */}
        <Link href="/previews" className="flex flex-col items-center gap-1 p-2 text-brand-gray">
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
