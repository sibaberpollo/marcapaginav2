        ...
        <div className="py-2">
          ...
          <div className="mb-6">
            ...
            <div
              ...
              data-testid="efemerides-scroll"
            >
              {data.efemerides.map((efemeride, index) => {
                const colors =
                  EFEMERIDE_COLORS[index % EFEMERIDE_COLORS.length];
                return (
                  <div
                    key={index}
                    className="w-80 flex-shrink-0"
                    data-testid="efemeride-card"
                  >
                    <div
                    ...
                    >
                      <div
                        className={`text-sm font-semibold mb-2 ${colors.text} ${colors.textDark}`}
                      >
                        {efemeride.date}
                      </div>
          ...
          <div className="space-y-8 pt-8">
            ...
            {(() => {
              const currentSignData = zodiacSigns.find(
                (sign) => sign.slug === currentSign,
              );
              return (
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {zodiacSigns
                ...
                .map((sign) => {
                  const literaryText =
                    literaryTexts[sign.slug as keyof typeof literaryTexts]
                      ?.text || "";
                  ...
                  const cardContent = (
                    <div
                      className={`relative bg-bg-primary rounded-xl shadow-md p-6 flex flex-col items-center text-center border border-surface transition-all duration-200 ${
                        isClickable
