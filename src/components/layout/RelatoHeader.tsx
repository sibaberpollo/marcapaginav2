...
export default function RelatoHeader() {
  ...
  return (
    <>
      {/* Header */}
      <header
        className={`fixed top-0 left-0 right-0 z-50 bg-bg-primary border-b border-surface-2 transition-transform duration-300 ${
          hidden ? '-translate-y-[56px]' : 'translate-y-0'
        }`}
      >
