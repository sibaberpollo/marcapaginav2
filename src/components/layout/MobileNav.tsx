  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-bg-primary border-t border-surface-2 z-50">
      <div className="flex justify-around py-2">
        ...
        <Link href="/narrativa" className="flex flex-col items-center gap-1 p-2 text-brand-gray">
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        <Link href="/escribir" className="flex flex-col items-center gap-1 p-2 text-brand-gray">
          <div className="w-10 h-10 bg-brand-yellow rounded-full flex items-center justify-center -mt-4 shadow-lg">
            <svg className="w-6 h-6 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4" />
            </svg>
          </div>
        </Link>
        <Link href="/guardados" className="flex flex-col items-center gap-1 p-2 text-brand-gray">
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
