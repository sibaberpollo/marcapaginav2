...
export default function TravelMap({
    ...
    return (
        ...
        >
            ...
            <MapUpdater
                center={activeLocationId
                    ? locations.find(l => l.id === activeLocationId)?.coordinates || mapCenter
                    : mapCenter
                }
            ...
            {locations.map((location) => (
                <Marker
                    ...
                    icon={createNumberedIcon(location.order, activeLocationId === location.id)}
                    eventHandlers={{
                    ...
                    <Popup>
                        <div className="p-2 min-w-[200px]">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <h3 className="font-bold text-brand-black-static">{location.name}</h3>
                            </div>
                            {location.subtitle && (
